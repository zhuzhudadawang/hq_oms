...
export const asyncRoutes = [
  ...
  children: [
    ...
    {
      path: 'fib-tem-estimated-revenue',
      name: 'FibTemEstimatedRevenue',
      component: () => import('@/views/business/fib-tem-estimated-revenue.vue'),
      meta: {
        title: 'FIB/TEM检测暂估收入',
        icon: 'Money',
        permissions: ['business:view']
    ...
    {
      path: 'zhuhai-estimated-revenue',
      name: 'ZhuhaiEstimatedRevenue',
      component: () => import('@/views/business/zhuhai-estimated-revenue.vue'),
      meta: {
        title: '珠海检测暂估收入',
        icon: 'Money',
        permissions: ['business:view']
    ...
    {
      path: 'laboratory-income',
      name: 'LaboratoryIncome',
      component: () => import('@/views/business/laboratory-income.vue'),
      meta: {
        title: '实验室收入分析表',
        icon: 'DataLine',
        permissions: ['business:view']
    ...
    {
      path: 'period-expenses',
      name: 'PeriodExpenses',
      component: () => import('@/views/business/period-expenses.vue'),
      meta: {
        title: '期间费用分析表',
        icon: 'DataLine',
        permissions: ['business:view']
    ...
    },
    {
      path: 'tax-table',
      name: 'TaxTable',
      component: () => import('@/views/business/tax-table.vue'),
      meta: {
        title: '税金表',
        icon: 'DataLine',
        permissions: ['business:view']
    ...
    },
    {
      ...
      component: () => import('@/views/business/cash-flow-forecast.vue'),
      meta: {
        title: '现金流量预测表',
        icon: 'DataLine',
        permissions: ['business:view']
    ...
    {
      path: 'core-operating-indicators',
      name: 'CoreOperatingIndicators',
      component: () => import('@/views/business/core-operating-indicators.vue'),
      meta: {
        title: '核心经营指标表',
        icon: 'DataLine',
        permissions: ['business:view']
